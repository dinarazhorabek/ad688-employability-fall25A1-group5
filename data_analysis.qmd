...
## Skill Gap Analysis — Team Skill Matrix
...
## Skill Gap Analysis — Extracting Industry Demand

```{python}
naics_data_industries = [51, 52, 54]
df_data_industry = lightcast_jp[
    lightcast_jp["NAICS2"].astype(float).isin(naics_data_industries)
]
...
## Skill Gap Analysis — Software Skill Extraction
...
## Skill Gap Analysis — Gap Calculation
